...
public class DriveToPosition extends CommandBase {
    ...
    public void execute() {
        ...
        double angleError = vec.getAngle().getDegrees() - chassis.heading();
        ChassisSpeeds chassisSpeed = new ChassisSpeeds(velocity, 0, angleError*angkeKP);
